    ...
    public static partial class DataGenerator
    {
        ...
        private static void GenerateAugmentData()
        {
            ...
            var augments = new[]
            {
                ...
                Mk("Aug_Chain", "연쇄", "타격 후 인접한 적에게 위력 50%의 연쇄 피해를 줍니다", AugmentType.Chain, SkillType.Attack, 2, false, ""),
                ...
                Mk("Aug_AOEAuto", "파동", "단일 대상 스킬이 자동으로 광역이 됩니다 (위력 50%)", AugmentType.AOEAuto, SkillType.Attack, 2, true, "코스트 +2",
                    Kw(KeywordType.CostAdd, 2)),

                Mk("Aug_Berserk", "광폭", "위력이 2배가 됩니다", AugmentType.Berserk, SkillType.Attack, 3, true, "HP 30% 이하일 때만 발동",
                    Kw(KeywordType.PowerMul, 2f, KeywordTrigger.HPBelow, 0.3f)),
            };
        ...
        private static void GenerateSpawnPatternTables()
        {
            ...
            CreateSpawnPatternTable("SpawnPatterns_F1",
                normalPatterns: new[]
                {
                    ...
                    ("숲의 정찰대",   new[]{("Enemy_Goblin",2),("Enemy_Wolf",2)}),          // 2*60+2*59=238
                    ("독 포자 군단",  new[]{("Enemy_Mushroom",3),("Enemy_Slime",3)}),       // 3*37+3*45=246
                    ("늑대 무리",     new[]{("Enemy_Wolf",4)}),                              // 4*59=236
                    ("고블린 약탈단", new[]{("Enemy_Goblin",3),("Enemy_Slime",1)}),         // 3*60+45=225
            ...
            CreateSpawnPatternTable("SpawnPatterns_F2",
                normalPatterns: new[]
                {
                    ...
                    ("미라 군단",     new[]{("Enemy_Mummy",2),("Enemy_Skeleton",2)}),           // 2*70+2*50=240
            ...
            CreateSpawnPatternTable("SpawnPatterns_F3",
                normalPatterns: new[]
                {
                    ("심연의 그림자", new[]{("Enemy_Shadow",3),("Enemy_Wraith",2)}),           // 3*67+2*75=351
                    ("악마 군단",     new[]{("Enemy_DemonSoldier",3),("Enemy_Shadow",2)}),     // 3*82+2*67=380
                    ("망령 떼",       new[]{("Enemy_Wraith",4),("Enemy_Shadow",1)}),           // 4*75+67=367
                    ("석조 수호대",   new[]{("Enemy_Gargoyle",3),("Enemy_DemonSoldier",1)}),   // 3*68+82=286
