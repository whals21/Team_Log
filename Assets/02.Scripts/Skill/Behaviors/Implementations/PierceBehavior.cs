...
namespace TeamLog.Skill.Behaviors.Implementations
{
    ...
    /// 기존 SkillExecutor.ExecuteAttack의 if(Pierce) 블록과 동일한 로직.
    ...
    public class PierceBehavior : ISkillBehavior
    {
        ...
        public ExecutionPhase Phases => ExecutionPhase.DamageApply;
        public int Order => 10; // DamageApply 중 가장 먼저 (기본 DealDamage 스킵)

        public void ApplyDamage(SkillExecContext ctx)
        {
